...
- **J6, J9 still open** -- no JLCPCB catalog match found yet for the JST-PH 3-pin (J6) or shrouded 2x3 IDC (J9) connector footprints. Next session: either find real catalog matches by footprint, or flip both to hand-solder like J2/J3 if nothing suitable turns up.
